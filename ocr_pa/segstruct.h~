...
int segline(SDL_Surface *img,struct line *line_tab,
...
int segBloc(SDL_Surface *img, struct blocX *blocX_tab,int sizeblocX,
		struct blocY *blocY_tab,int sizeblocY, struct Bloc *Bloc_tab,
		int bloc_tabsize);
int segBloc2(SDL_Surface *img, struct Bloc *Bloc_tab
		,int Bloc_size, int bloc_tabsize);
